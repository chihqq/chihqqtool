...
/**
 * Created by ChenHao on 2022/12/17 is 11:30.
 *
 * @author tsinglink
 */
...
//                .setPrettyPrinting() //自动格式化换行
	...
	/**
	 * 将json转化为对应的实体对象 new TypeToken<List<T>>() {}.getType() new TypeToken<Map<String, T>>()
	 * {}.getType() new TypeToken<List<Map<String, T>>>() {}.getType()
	 */
	...
	public static HashMap<String, BigDecimal> strToMapsBig(String gsonString) {
		return GSON.fromJson(gsonString, new TypeToken<HashMap<String, BigDecimal>>() {
		}.getType());
	}

	public static HashMap<Date, BigDecimal> strToMapsDateBig(String gsonString) {
		return GSON.fromJson(gsonString, new TypeToken<HashMap<Date, BigDecimal>>() {
		}.getType());
	}

	public static JsonElement strToJsonElement(Map<String, Object> param) {
		return strToJsonElement(GSON.toJson(param));
	}

	public static JsonElement strToJsonElement(String gsonString) {
